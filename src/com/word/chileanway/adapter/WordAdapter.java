...
public class WordAdapter<T> extends BaseAdapter implements Filterable {
    /**
    ...
    public WordAdapter(Context context, int resource) {
        init(context, resource, 0, new ArrayList<WordVO>());
    }
    ...
    public WordAdapter(Context context, int resource, int textViewResourceId) {
        init(context, resource, textViewResourceId, new ArrayList<WordVO>());
    }
     ...
     */
    public WordAdapter(Context context, int resource, WordVO[] objects) {
     ...
     * @param objects The objects to represent in the ListView.
     */
    public WordAdapter(Context context, int resource, int textViewResourceId, WordVO[] objects) {
     ...
     * @param objects The objects to represent in the ListView.
     */
    public WordAdapter(Context context, int resource, int textViewResourceId, List<WordVO> objects) {
     ...
     */
    public void addAll(Collection<? extends WordVO> collection) {
        synchronized (mLock) {
            if (mOriginalValues != null) {
     ...
     */
    public void addAll(WordVO ... items) {
        synchronized (mLock) {
            if (mOriginalValues != null) {
     ...
     */
    public void insert(WordVO object, int index) {
        synchronized (mLock) {
            if (mOriginalValues != null) {
     ...
     */
    public void remove(WordVO object) {
        synchronized (mLock) {
            if (mOriginalValues != null) {
     ...
     *        in this adapter.
     */
    public void sort(Comparator<? super WordVO> comparator) {
        synchronized (mLock) {
            if (mOriginalValues != null) {
    ...
    private void init(Context context, int resource, int textViewResourceId, List<WordVO> objects) {
        mContext = context;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
		...
		txtTitle.setText(mObjects.get(position).getSpanish());
		return rowView;
    }
